...
//    int AddDeepFctModel2List(string slot_key, string fea_key, bool add);
    ...
    string ProcLabel(string input_type);
    string ToLower(string& s);
    
    void Init(char* embfile, char* traindata, int rank);
